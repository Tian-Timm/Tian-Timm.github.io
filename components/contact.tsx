  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "hyt206157@gemail.com",
      link: "mailto:hyt206157@gemail.com",
    },
    {
      icon: <Phone className="h-6 w-6 text-primary" />,
      title: "Phone",
      value: "+86 13683131728",
      link: "tel:+8613683131728",
    },
    {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="subject"
                      name="subject"
                      placeholder="Collaboration / Academic Inquiry"
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="message"
                      name="message"
                      placeholder="I'm interested in your experiments with..."
                      rows={6}
